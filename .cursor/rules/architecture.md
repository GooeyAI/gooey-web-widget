...
- Header: `src/widgets/copilot/components/Header/index.tsx` handles UI controls and share dialog locally (builds share URL from `currentConversationId`, manages dialog state).
